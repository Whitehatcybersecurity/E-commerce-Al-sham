                ...
                <div class="swiper-slide banner banner-fixed intro-slide intro-slide3"
                    ...
                    <div class="container">
                        <figure class="slide-image skrollable slide-animate" data-animation-options="{
                            ...
                            <img src="{{ asset('frontend/assets/images/demos/demo1/sliders/skate.png') }}" alt="Banner"
                                data-bottom-top="transform: translateY(10vh);"
     ...
     'disableOnInteraction': false
            ...
            <div class="swiper-wrapper">
                {{-- @foreach ($mainbanners as $mainbanner) --}}
                    <div class="swiper-slide banner banner-fixed intro-slide intro-slide1">
                        <img src="{{ asset('assets/frontend/assets/images/main_banner/banner_hardware.png') }}" style="height:335px;">
                        {{-- style="height:520px;"> --}}
                        <div class="container">
                            <div class="banner-content y-50 text-center" style="margin-top: 160px; margin-left:110px;">
                                <a href=""
                                    class="btn btn-dark btn-outline btn-rounded btn-icon-right slide-animate"
                                    data-animation-options="{
                    'name': 'fadeInRightShorter',
        ...
        <div class="row category-banner-wrapper appear-animate pt-6 pb-8">
            <div class="col-md-6 mb-4">
                <div class="banner banner-fixed br-xs">
                    <figure>
                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/categories/middle_banner-1.jpg') }}" alt="Category Banner"
            ...
            <div class="col-md-6 mb-4">
                <div class="banner banner-fixed br-xs">
                    <figure>
                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/categories/middle_banner-2.jpg') }}" alt="Category Banner"
                                                        ...
                                                        <div class="swiper-slide">
                                                            <figure class="product-image">
                                                                <img src="{{ asset('frontend/assets/images/demos/demo1/products/2-4-600x675.jpg') }}"
                                                                    data-zoom-image="{{ asset('assets/images/demos/demo1/products/2-4-800x900.jpg') }}"
                                                                    alt="Product Image" width="800"
                                                                    height="900">
                                                            </figure>
                                                        </div>
                    ...
                    <div class="swiper-wrapper row cols-lg-6 cols-md-5 cols-sm-3 cols-2">
                        ...
                        <div
                            ...
                            <a href="shop-banner-sidebar.html" class="category-media">
                                <img src="{{ asset($category->category_image) }}" alt="Category"
                        ...
                        {{-- <div
                            class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                            <a href="shop-banner-sidebar.html" class="category-media">
                                <img src="{{ asset('assets/frontend/assets/images/demos/demo1/categories/2-2.jpg') }}" alt="Category"
                                    width="130" height="130">
                            </a>
                            <div class="category-content">
                        ...
                        <div
                            class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                            <a href="shop-banner-sidebar.html" class="category-media">
                                <img src="{{ asset('assets/frontend/assets/images/demos/demo1/categories/2-3.jpg') }}" alt="Category"
                                    width="130" height="130">
                            </a>
                            <div class="category-content">
                        ...
                        <div
                            class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                            <a href="shop-banner-sidebar.html" class="category-media">
                                <img src="{{ asset('assets/frontend/assets/images/demos/demo1/categories/2-4.jpg') }}" alt="Category"
                                    width="130" height="130">
                            </a>
                            <div class="category-content">
                        ...
                        <div
                            class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                            <a href="shop-banner-sidebar.html" class="category-media">
                                <img src="{{ asset('assets/frontend/assets/images/demos/demo1/categories/2-5.jpg') }}" alt="Category"
                                    width="130" height="130">
                            </a>
                            <div class="category-content">
                        ...
                        <div
                            class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                            <a href="shop-banner-sidebar.html" class="category-media">
                                <img src="{{ asset('assets/frontend/assets/images/demos/demo1/categories/2-6.jpg') }}" alt="Category"
                                    width="130" height="130">
                            </a>
                            <div class="category-content">
    ...
    <div class="container">
        ...
        <div class="product-wrapper-1 appear-animate mb-5">
            <div class="title-link-wrapper pb-1 mb-4">
                <h2 class="title ls-normal mb-0">{{ $categorie3->category_name }}</h2>
                <a href="shop-boxed-banner.html" class="font-size-normal font-weight-bold ls-25 mb-0">More
                    Products<i class="w-icon-long-arrow-right"></i></a>
            </div>
            <div class="row">
                <div class="col-lg-3 col-sm-4 mb-4">
                    <div class="banner h-100 br-sm" style="background-image: url({{ asset('assets/frontend/assets/images/demos/demo1/banners/sidebanner_3.jpg') }}); 
                ...
                @php 
                    $products = App\Models\Product::where('category_id',$categorie3->id)->take(8)->get();
                @endphp
                <!-- End of Banner -->
                                    ...
                                    {{-- <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2"> --}}
                                        {{-- <div class="swiper-slide product-col"> --}}
                                            <div class="product-wrap product text-center">
                                                <figure class="product-media">
                                                    <a href="{{ route('productdetailsview', ['id' => $product->id]) }}">
                                                ...
                                                <div class="product-details">
                                                    <h4 class="product-name"><a href="product-default.html">{{ $product->product_name }}</a>
                                                    </h4>
                                                    <div class="ratings-container">
                                                        <div class="ratings-full">
                                                            <span class="ratings" style="width: 60%;"></span>
                                            ...
                                            {{-- <div class="product-wrap product text-center">
                                                <figure class="product-media">
                                                    <a href="#">
                                                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/4-5-1.jpg') }}"
                                                            alt="Product" width="216" height="243" />
                                                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/4-5-2.jpg') }}"
                                                            alt="Product" width="216" height="243" />
                                                    </a>
                                                    <div class="product-action-vertical">
                                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        {{-- <div class="swiper-slide product-col">
                                            <div class="product-wrap product text-center">
                                                <figure class="product-media">
                                                    <a href="#">
                                                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/4-2-1.jpg') }}"
                                                            alt="Product" width="216" height="243" />
                                                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/4-2-2.jpg') }}"
                                                            alt="Product" width="216" height="243" />
                                                    </a>
                                                    <div class="product-action-vertical">
                                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                            ...
                                            <div class="product-wrap product text-center">
                                                <figure class="product-media">
                                                    <a href="#">
                                                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/4-6.jpg') }}" alt="Product"
                                                            width="216" height="243" />
                                                    </a>
                                                    <div class="product-action-vertical">
                                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="swiper-slide product-col">
                                            <div class="product-wrap product text-center">
                                                <figure class="product-media">
                                                    <a href="#">
                                                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/4-3.jpg') }}" alt="Product"
                                                            width="216" height="243" />
                                                    </a>
                                                    <div class="product-action-vertical">
                                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                            ...
                                            <div class="product-wrap product text-center">
                                                <figure class="product-media">
                                                    <a href="#">
                                                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/4-7.jpg') }}" alt="Product"
                                                            width="216" height="243" />
                                                    </a>
                                                    <div class="product-action-vertical">
                                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="swiper-slide product-col">
                                            <div class="product-wrap product text-center">
                                                <figure class="product-media">
                                                    <a href="#">
                                                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/4-4-1.jpg') }}"
                                                            alt="Product" width="216" height="243" />
                                                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/4-4-2.jpg') }}"
                                                            alt="Product" width="216" height="243" />
                                                    </a>
                                                    <div class="product-action-vertical">
                                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                            ...
                                            <div class="product-wrap product text-center">
                                                <figure class="product-media">
                                                    <a href="#">
                                                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/4-8.jpg') }}" alt="Product"
                                                            width="216" height="243" />
                                                    </a>
                                                    <div class="product-action-vertical">
                                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
        ...
        {{-- <div class="product-wrapper-1 appear-animate mb-8">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-4 mb-4">
                    <div class="banner h-100 br-sm" style="background-image: url({{ asset('assets/frontend/assets/images/demos/demo1/banners/3.jpg') }}); 
                        ...
                        <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2">
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/5-1-1.jpg') }}"
                                                alt="Product" width="216" height="243" />
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/5-1-2.jpg') }}"
                                                alt="Product" width="216" height="243" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="product-wrap product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/5-5.jpg') }}" alt="Product"
                                                width="216" height="243" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                            ...
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/5-2-1.jpg') }}"
                                                alt="Product" width="216" height="243" />
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/5-2-2.jpg') }}"
                                                alt="Product" width="216" height="243" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="product-wrap product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/5-6.jpg') }}" alt="Product"
                                                width="216" height="243" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                            ...
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/5-3.jpg') }}" alt="Product"
                                                width="216" height="243" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="product-wrap product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/5-7.jpg') }}" alt="Product"
                                                width="216" height="243" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                            ...
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/5-4.jpg') }}" alt="Product"
                                                width="216" height="243" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="product-wrap product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/5-8.jpg') }}" alt="Product"
                                                width="216" height="243" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
        ...
        {{-- <div class="banner banner-fashion appear-animate br-sm mb-9" style="background-image: url({{ asset('assets/frontend/assets/images/demos/demo1/banners/4.jpg') }});
        ...
        {{-- <div class="product-wrapper-1 appear-animate mb-7">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-4 mb-4">
                    <div class="banner h-100 br-sm" style="background-image: url({{ asset('assets/frontend/assets/images/demos/demo1/banners/5.jpg') }}); 
                        ...
                        <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2">
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/6-1.jpg') }}" alt="Product"
                                                width="216" height="243" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="product-wrap product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/6-5.jpg') }}" alt="Product"
                                                width="216" height="243" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                            ...
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/6-2-1.jpg') }}"
                                                alt="Product" width="216" height="243" />
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/6-2-2.jpg') }}"
                                                alt="Product" width="216" height="243" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="product-wrap product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/6-6.jpg') }}" alt="Product"
                                                width="216" height="243" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                            ...
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/6-3-1.jpg') }}"
                                                alt="Product" width="216" height="243" />
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/6-3-2.jpg') }}"
                                                alt="Product" width="216" height="243" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="product-wrap product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/6-7.jpg') }}" alt="Product"
                                                width="216" height="243" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                            ...
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/6-4.jpg') }}" alt="Product"
                                                width="216" height="243" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="product-wrap product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/6-8-1.jpg') }}"
                                                alt="Product" width="216" height="243" />
                                            <img src="{{ asset('assets/frontend/assets/images/demos/demo1/products/6-8-2.jpg') }}"
                                                alt="Product" width="216" height="243" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
            ...
            <div class="swiper-wrapper row gutter-no cols-xl-6 cols-lg-5 cols-md-4 cols-sm-3 cols-2">
                ...
                <div class="swiper-slide brand-col">
                    <figure class="brand-wrapper">
                        <img src="{{ asset($brand->brand_image) }}" alt="Brand" width="410"
                            height="186" />
                    </figure>
                    {{-- <figure class="brand-wrapper">
                        <img src="{{ asset($brand->brand_image) }}" alt="Brand" width="410"
                ...
                {{-- <div class="swiper-slide brand-col">
                    <figure class="brand-wrapper">
                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/brands/3.png') }}" alt="Brand" width="410"
                            height="186" />
                    </figure>
                    <figure class="brand-wrapper">
                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/brands/4.png') }}" alt="Brand" width="410"
                            height="186" />
                    </figure>
                </div>
                <div class="swiper-slide brand-col">
                    <figure class="brand-wrapper">
                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/brands/5.png') }}" alt="Brand" width="410"
                            height="186" />
                    </figure>
                    <figure class="brand-wrapper">
                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/brands/6.png') }}" alt="Brand" width="410"
                            height="186" />
                    </figure>
                </div>
                <div class="swiper-slide brand-col">
                    <figure class="brand-wrapper">
                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/brands/7.png') }}" alt="Brand" width="410"
                            height="186" />
                    </figure>
                    <figure class="brand-wrapper">
                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/brands/8.png') }}" alt="Brand" width="410"
                            height="186" />
                    </figure>
                </div>
                <div class="swiper-slide brand-col">
                    <figure class="brand-wrapper">
                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/brands/9.png') }}" alt="Brand" width="410"
                            height="186" />
                    </figure>
                    <figure class="brand-wrapper">
                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/brands/10.png') }}" alt="Brand" width="410"
                            height="186" />
                    </figure>
                </div>
                <div class="swiper-slide brand-col">
                    <figure class="brand-wrapper">
                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/brands/11.png') }}" alt="Brand" width="410"
                            height="186" />
                    </figure>
                    <figure class="brand-wrapper">
                        <img src="{{ asset('assets/frontend/assets/images/demos/demo1/brands/12.png') }}" alt="Brand" width="410"
                            height="186" />
                    </figure>
                </div> --}}
            </div>
