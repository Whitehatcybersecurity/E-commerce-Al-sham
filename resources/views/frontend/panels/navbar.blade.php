    ...
    <div class="header-top">
        <div class="container">
            <div class="header-left">
                <p class="welcome-msg">Welcome to Ali Al Sham electronics trading llc</p>
            </div>
            <div class="header-right">
                ...
                @if(Auth::user() == null)
                <a href="{{ route('loginview') }}" class="d-lg-show login"><i
                        class="w-icon-account"></i>Sign In</a>
                <span class="delimiter d-lg-show">/</span>
                <a href="{{ route('registerview') }}" class="ml-0 d-lg-show login">Register</a>
                @else
                <a href="{{ route('customerlogout') }}" class="d-lg-show login"><i
    ...
    <div class="header-middle">
        <div class="container">
            <div class="header-left mr-md-4">
                ...
                <a href="{{ route('homeview') }}" class="logo ml-lg-0">
                    <img src="{{ asset('assets/frontend/assets/images/logo.png') }}" alt="logo" width="144" height="45" />
                </a>
            ...
            <div class="header-right ml-4">
                <div class="header-call d-xs-show d-lg-flex align-items-center">
                    ...
                    <div class="call-info d-lg-show">
                        <h4 class="chat font-weight-normal font-size-md text-normal ls-normal text-light mb-0">
                            <a href="" class="text-capitalize">Mobile No:</a></h4>
                        <a href="tel:#" class="phone-number font-weight-bolder ls-50">+971 557624300</a>
                    </div>
                </div>
                ...
                <div class="dropdown cart-dropdown cart-offcanvas mr-0 mr-lg-2">
                    ...
                    <a href="{{ route('cartview') }}" class="cart-toggle label-down link">
                        <i class="w-icon-cart">
                    ...
                    <div class="dropdown-box">
                        <div class="cart-header">
                            ...
                            <a href="{{ route('cartview') }}" class="btn-close">Close<i class="w-icon-long-arrow-right"></i></a>
                        </div>
                        ...
                        <div class="products">
                            <div class="product product-cart">
                                ...
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{ asset('assets/frontend/assets/images/cart/product-1.jpg') }}" alt="product" height="84"
                                            width="94" />
                                    </a>
                                </figure>
                            ...
                            <div class="product product-cart">
                                ...
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{ asset('assets/frontend/assets/images/cart/product-2.jpg') }}" alt="product" width="84"
                                            height="94" />
                                    </a>
                                </figure>
                                <button class="btn btn-link btn-close" aria-label="button">
                                    ...
                                    <ul class="megamenu">
                                        ...
                                        <li>
                                            <div class="menu-banner banner-fixed menu-banner3">
                                                <figure>
                                                    <img src="{{ asset('frontend/assets/images/menu/banner-3.jpg') }}" alt="Menu Banner"
                                    ...
                                    <ul class="megamenu">
                                        ...
                                        <li>
                                            <div class="menu-banner banner-fixed menu-banner4">
                                                <figure>
                                                    <img src="{{ asset('frontend/assets/images/menu/banner-4.jpg') }}" alt="Menu Banner"
                                        ...
                                        <li class="row">
                                            <div class="col-6">
                                                <div class="banner banner-fixed menu-banner5 br-xs">
                                                    <figure>
                                                        <img src="{{ asset('frontend/assets/images/menu/banner-5.jpg') }}" alt="Banner"
                                            ...
                                            <div class="col-6">
                                                <div class="banner banner-fixed menu-banner5 br-xs">
                                                    <figure>
                                                        <img src="{{ asset('frontend/assets/images/menu/banner-6.jpg') }}" alt="Banner"
                                                            width="410" height="123"
